...
if [ -f ../../.env.sqlite ]; then
  ...
  if [ ! -s ../../data/black_alder_platform.db ]; then
...
# Ensure the black-alder-platform namespace exists
kubectl apply -f ../../black-alder-platform-namespace.yaml
...
kubectl apply -f ../../black-alder-platform-cell-xrd.yaml
...
kubectl apply -f ../../black-alder-platform-cell-composition-aws.yaml
...
kubectl get cellclaim core-services-cell -n black-alder-platform -o wide || echo "CellClaim not yet available"
...
echo "- kubectl get cellclaim -n black-alder-platform     # List cell claims in black-alder-platform namespace"
echo ""
