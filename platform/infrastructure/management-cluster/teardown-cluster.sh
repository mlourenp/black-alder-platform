...
if kubectl get namespace black-alder-platform &>/dev/null; then
  echo "Found Cell deployment in black-alder-platform namespace, cleaning up..."
  ...
  kubectl delete cellclaim --all -n black-alder-platform 2>/dev/null || true
  ...
  # Delete any remaining deployments in the black-alder-platform namespace
  echo "Removing any remaining deployments in the black-alder-platform namespace..."
  kubectl delete deployments --all -n black-alder-platform 2>/dev/null || true
  kubectl delete services --all -n black-alder-platform 2>/dev/null || true
  kubectl delete configmaps --all -n black-alder-platform 2>/dev/null || true
  kubectl delete secrets --all -n black-alder-platform 2>/dev/null || true

  # Delete the namespace itself
  echo "Removing black-alder-platform namespace..."
  kubectl delete namespace black-alder-platform --wait=false 2>/dev/null || true
...
if kubectl get namespace crossplane-system &>/dev/null; then
  ...
  kubectl delete -f black-alder-platform-cell-xrd.yaml --ignore-not-found=true --wait=false || true
