# Multi-region deployment module for Black Alder Platform

# Route53 Global DNS Zone
resource "aws_route53_zone" "black_alder_platform" {
...
resource "aws_route53_record" "api_global" {
  zone_id = aws_route53_zone.black_alder_platform.zone_id
...
resource "aws_cloudfront_distribution" "api_distribution" {
  ...
  comment             = "Black Alder Platform Global API Distribution"
  default_root_object = ""
