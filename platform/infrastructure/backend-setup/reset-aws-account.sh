...
read -p "Enter base name for S3 bucket [black-alder-platform-terraform-state]: " BASE_BUCKET_NAME
BASE_BUCKET_NAME=${BASE_BUCKET_NAME:-"black-alder-platform-terraform-state"}

read -p "Enter DynamoDB table name [black-alder-platform-terraform-locks]: " DYNAMODB_TABLE_NAME
DYNAMODB_TABLE_NAME=${DYNAMODB_TABLE_NAME:-"black-alder-platform-terraform-locks"}
