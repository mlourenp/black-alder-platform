...
module "vpc_us_west_2" {
  ...
  vpc_name       = "black-alder-platform-vpc-us-west-2"
...
module "vpc_us_east_1" {
  ...
  vpc_name       = "black-alder-platform-vpc-us-east-1"
...
module "vpc_eu_west_1" {
  ...
  vpc_name       = "black-alder-platform-vpc-eu-west-1"
...
module "eks_us_west_2" {
  ...
  cluster_name    = "black-alder-platform-eks-us-west-2"
...
resource "aws_kms_key" "eks_secrets_us_west_2" {
  ...
  tags = {
    Name        = "black-alder-platform-eks-secrets-key-us-west-2"
    Environment = "prod"
    Region      = "us-west-2"
    ManagedBy   = "Terraform"
  }
...
module "eks_us_east_1" {
  ...
  cluster_name    = "black-alder-platform-eks-us-east-1"
  kubernetes_version = "1.26"
...
resource "aws_kms_key" "eks_secrets_us_east_1" {
  ...
  tags = {
    Name        = "black-alder-platform-eks-secrets-key-us-east-1"
    Environment = "prod"
    Region      = "us-east-1"
    ManagedBy   = "Terraform"
  }
...
module "eks_eu_west_1" {
  ...
  cluster_name    = "black-alder-platform-eks-eu-west-1"
  kubernetes_version = "1.26"
...
resource "aws_kms_key" "eks_secrets_eu_west_1" {
  ...
  tags = {
    Name        = "black-alder-platform-eks-secrets-key-eu-west-1"
    Environment = "prod"
    Region      = "eu-west-1"
    ManagedBy   = "Terraform"
  }
...
module "multi_region" {
  ...
  project_name = "black-alder-platform"
  domain_name  = "black-alder-platform.com" # Replace with actual domain
...
resource "aws_acm_certificate" "global_cert" {
  ...
  domain_name       = "black-alder-platform.com"
  validation_method = "DNS"

  subject_alternative_names = [
    "*.black-alder-platform.com"
  ]
  ...
  tags = {
    Name        = "black-alder-platform-global-cert"
    Environment = "prod"
    ManagedBy   = "Terraform"
  }
}
