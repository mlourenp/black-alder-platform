# Black Alder Infrastructure Platform - Main Configuration
# Open-core infrastructure canopy layer with toggleable observability
...
module "telemetry_agent" {
  ...
  cloud_provider = var.cloud_provider
  region = var.region
  telemetry_endpoint = var.telemetry_endpoint != "" ? var.telemetry_endpoint : "https://telemetry.black-alder-platform.com/v1/collect"
