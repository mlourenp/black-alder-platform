...
# Black Alder Platform Startup Script
...
# Black Alder Platform Configuration
...
show_access_information() {
    ...
    echo "    kubectl port-forward -n black-alder-observability svc/prometheus-grafana 3000:80"
    echo ""
...
# Main execution
main() {
    log_header "Black Alder Platform Startup"
    
    log_info "Starting Black Alder Platform deployment..."
    ...
    log_success "Black Alder Platform startup completed successfully!"
