...
# Black Alder Platform - Quick Environment Setup Script
...
cat << "EOF"
╔═══════════════════════════════════════════════════════════════╗
║           Black Alder Platform v1.2 Environment Setup              ║
...
if kubectl get namespace black-alder-platform-testing >/dev/null 2>&1; then
    log_success "Test namespace already exists"
else
    kubectl create namespace black-alder-platform-testing
    log_success "Created test namespace: black-alder-platform-testing"
fi
