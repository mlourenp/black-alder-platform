...
# Publish Black Alder Platform to GitHub
# This script helps you publish the black-alder-platform repository to GitHub
...
if [[ ! -f "README.md" ]] || [[ ! -d "modules" ]] || [[ ! -f "main.tf" ]]; then
    log_error "This script must be run from the black-alder-platform repository root"
    exit 1
fi

log_header "Publishing Black Alder Platform to GitHub"
...
REPO_URL="https://github.com/${GITHUB_USERNAME}/black-alder-platform.git"
...
if grep -q "github.com/your-org" README.md; then
    ...
    sed -i.bak "s|github.com/your-org/black-alder-platform|github.com/${GITHUB_USERNAME}/black-alder-platform|g" README.md
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    git tag -a v1.2.0 -m "Initial release: Black Alder Platform v1.2.0
...
echo
log_success "🎉 Black Alder Platform published to GitHub!"
echo
echo "📁 Repository: ${BOLD}https://github.com/${GITHUB_USERNAME}/black-alder-platform${NC}"
echo
echo "🔧 ${BOLD}Next Steps:${NC}"
echo "   1. 🌐 Visit your repository: https://github.com/${GITHUB_USERNAME}/black-alder-platform"
