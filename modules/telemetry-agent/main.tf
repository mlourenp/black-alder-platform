    ...
    "config.yaml" = yamlencode({
      telemetry = {
        ...
        consent = {
          timestamp = timestamp()
          version = "1.0"
          privacy_policy_url = "https://black-alder-platform.com/privacy"
          terms_url = "https://black-alder-platform.com/terms"
        }
...
For more information: https://black-alder-platform.com/privacy
EOT
  }
}
  ...
  spec {
    ...
    template {
      ...
      spec {
        ...
        container {
          name  = "telemetry-agent"
          image = "black-alder-platform/prism-telemetry-agent:v1.2.0"
