...
variable "telemetry_endpoint" {
  ...
  type        = string
  default     = "https://telemetry.black-alder-platform.io/v1/metrics"
}
    ...
    "config.yaml" = yamlencode({
      telemetry = {
        ...
        consent = {
          timestamp = timestamp()
          version = "1.0"
          privacy_policy_url = "https://black-alder-platform.io/privacy"
        }
      }
  ...
  spec {
    ...
    template {
      ...
      spec {
        ...
        container {
          name  = "telemetry-agent"
          image = "black-alder-platform/telemetry-agent:v1.0.0"
